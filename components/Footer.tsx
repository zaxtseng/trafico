...
import { IFooter } from "../typings/home.types";
...
const Footer = ({ footerData }: { footerData: IFooter }) => {
  ...
  return (
    <footer className="bg-darkblue lg:bg-transparent lg:bg-footer lg:bg-no-repeat lg:bg-left-bottom lg:min-h-[738px] pt-12 lg:pt-0 relative">
      <motion.div variants={staggerFooterContainer}
      initial='initial' whileInView='animate' viewport={{once: false, amount: 0.1}} className="container mx-auto lg:min-h-[738px] flex flex-col justify-between">
        {/* truck image */}
